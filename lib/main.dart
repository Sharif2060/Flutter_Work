...
import 'package:amrendra_app/question_storage.dart';
...
class _QuizAppState extends State<QuizApp> {
    ...
    return SingleChildScrollView(
      ...
      child: Row(
        ...
        if (_test.quesList[idx].getStatus() == null)
          return Container(
            color:
                _test.index == idx ? Color.fromARGB(255, 249, 249, 248) : null,
            child: IconButton(
              icon: Icon(Icons.circle_outlined, color: Colors.blue, size: 40.0),
          ...
          return (_test.quesList[idx].getStatus() ?? false)
              ? Container(
                  color: _test.index == idx
                      ? const Color.fromARGB(255, 59, 203, 255)
                      : null,
                  child: IconButton(
                    icon: Icon(
                      Icons.done_rounded,
  ...
  Widget _quizComplete() {
    return Column(
      ...
      children: <Widget>[
        Material(
          color: Color.fromARGB(255, 222, 157, 88),
          elevation: 50,
          child: Container(
            height: 200,
            width: 350,
